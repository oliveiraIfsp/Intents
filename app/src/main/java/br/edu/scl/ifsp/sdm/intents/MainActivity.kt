...
private const val s = "Permission required to make calls"
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //substitui override fun onActivityResult
        ...
        callPhonePermissionArl = registerForActivityResult(ActivityResultContracts.RequestPermission()){
            ...
            Toast.makeText(this,
                getString(R.string.permission_required_to_make_calls), Toast.LENGTH_SHORT).show()
            }
        }
        ...
        activityMainBinding.apply {
            parameterBt.setOnClickListener {
                ...
                // startActivityForResult(parameterIntent, PARAMETER_REQUEST_CODE) // deprecated
